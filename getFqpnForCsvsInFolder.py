...
def getFqpnForCsvsInFolder(folder=None):
    ...
    '''
    if folder is None:
        print 'WARNING: getFqpnForCsvsInFolder(): Folder is undefined. Returning'
        return

    if not os.path.isdir(folder):
        print 'WARNING: getFqpnForCsvsInFolder(): Folder is not a valid folder:\n\t' \
            + folder 
        return
...
if __name__ == "__main__":
    ...
    print getFqpnForCsvsInFolder(pathToData)