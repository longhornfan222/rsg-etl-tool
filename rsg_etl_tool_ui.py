...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QListWidgetItem()
        self.lstColumnsInSelectedFile.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.lstColumnsInSelectedFile.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.lstColumnsInSelectedFile.addItem(item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.lstColumnsInSelectedFile.isSortingEnabled()
        self.lstColumnsInSelectedFile.setSortingEnabled(False)
        item = self.lstColumnsInSelectedFile.item(0)
        item.setText(_translate("MainWindow", "FAWN Station"))
        item = self.lstColumnsInSelectedFile.item(1)
        item.setText(_translate("MainWindow", "Observation Time"))
        item = self.lstColumnsInSelectedFile.item(2)
        item.setText(_translate("MainWindow", "60cm T air (F)"))
        item = self.lstColumnsInSelectedFile.item(3)
        item.setText(_translate("MainWindow", "2m T air (F)"))
        item = self.lstColumnsInSelectedFile.item(4)
        item.setText(_translate("MainWindow", "..."))
        self.lstColumnsInSelectedFile.setSortingEnabled(__sortingEnabled)
