...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.butOpenFolder.setMaximumSize(QtCore.QSize(16777215, 25))
        ...
        self.tableWidgetAttributesInSelectedTable = QtWidgets.QTableWidget(self.layoutWidget3)
        self.tableWidgetAttributesInSelectedTable.setEnabled(True)
        self.tableWidgetAttributesInSelectedTable.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tableWidgetAttributesInSelectedTable.setDragDropOverwriteMode(False)
        self.tableWidgetAttributesInSelectedTable.setAlternatingRowColors(False)
        self.tableWidgetAttributesInSelectedTable.setObjectName("tableWidgetAttributesInSelectedTable")
        self.tableWidgetAttributesInSelectedTable.setColumnCount(5)
        self.tableWidgetAttributesInSelectedTable.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidgetAttributesInSelectedTable.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidgetAttributesInSelectedTable.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidgetAttributesInSelectedTable.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidgetAttributesInSelectedTable.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidgetAttributesInSelectedTable.setHorizontalHeaderItem(4, item)
        self.verticalLayout_4.addWidget(self.tableWidgetAttributesInSelectedTable)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableWidgetAttributesInSelectedTable.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Attribute Name"))
        item = self.tableWidgetAttributesInSelectedTable.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Data Type"))
        item = self.tableWidgetAttributesInSelectedTable.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Can Be Null"))
        item = self.tableWidgetAttributesInSelectedTable.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Is Primary Key"))
        item = self.tableWidgetAttributesInSelectedTable.horizontalHeaderItem(4)
